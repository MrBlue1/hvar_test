...
# =====================================================
# 对照组：分层 KMeans 聚类（与 Statistical 实验一致）
# =====================================================
...
def run_2d_experiment(test_sizes=[20, 50, 100, 200], 
    ...
    # 保存到CSV
    csv_file = f"rbf_experiment_matrix_seed{seed}.csv"
