...
Mutation Operator: BCR
Description: 维度不匹配
Original: (variance + self.variance_epsilon)
Mutated: (variance.squeeze() + self.variance_epsilon)
"""
...
class RMSNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        x_norm = x * torch.rsqrt(variance.squeeze() + self.variance_epsilon)
