...
Mutation Operator: NPR
Description: epsilon缩小
Original: self.variance_epsilon)
Mutated: self.variance_epsilon / 1e6)
"""
...
class RMSNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        x_norm = x * torch.rsqrt(variance + self.variance_epsilon / 1e6)
