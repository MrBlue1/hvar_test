...
Mutation Operator: DTR
Description: float32->float64
Original: torch.randn(2, 8, 4096)
Mutated: torch.randn(2, 8, 4096, dtype=torch.float64)
"""
...
if __name__ == "__main__":
    ...
    x = torch.randn(2, 8, 4096, dtype=torch.float64)
