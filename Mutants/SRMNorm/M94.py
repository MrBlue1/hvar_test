...
Description: sqrt代替rsqrt
Original: torch.rsqrt
Mutated: 1/torch.sqrt(variance + self.variance_epsilon)
"""
...
class RMSNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        x_norm = x * 1/torch.sqrt(variance + self.variance_epsilon)(variance + self.variance_epsilon)
